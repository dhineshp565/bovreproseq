...
for (i in sampleid){
  ...
  colnames (results_df) <- c("SAMPLEID","PATHOGEN","QC STATUS","READ COUNTS","ABUNDANCE(%)","RESULT") 
  ...
  table_html <- knitr::kable(results_df, align = "lllccc", caption = "RESULTS SUMMARY - Based on abricate results with custom Bovreproseq database. For more info: Seemann T, Abricate, Github https://github.com/tseemann/abricate") %>%
    kable_styling()
