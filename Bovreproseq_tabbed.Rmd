...
for (i in sampleid){
  ...
  bracken_final <- bracken_raw[,c(1,6,7)]
  colnames(bracken_final) <- c("Organsim","Total reads", "Relative abundance")
  print(knitr::kable(bracken_final,align = "lcc",caption = "Bracken Species Abundance Table.Generated using kraken2 (kraken2 (https://ccb.jhu.edu/software/kraken2/) and Bracken (https://doi.org/10.7717/peerj-cs.104)") 
  %>%
    kable_styling())
}
```
