...
workflow {
	...
	make_report(QCREADS.out.csv,METAGENOMICS.out.krona_output,splitbam.out.mapped.collect(),abricate.out.abricate.collect(),abricate.out.results.collect(),rmd_file,mlst.out.collect(),medaka.out.cons_only.collect(),meta_bracken,meta_blast)
